...
link1_status=$(curl -Is https://download831.mediafire.com/yqfis6oajtug/5ia8weonns6nqne/Windows2012r.ISO | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is https://download831.mediafire.com/yqfis6oajtug/5ia8weonns6nqne/Windows2012r.ISO | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots https://download831.mediafire.com/yqfis6oajtug/5ia8weonns6nqne/Windows2012r.ISO
