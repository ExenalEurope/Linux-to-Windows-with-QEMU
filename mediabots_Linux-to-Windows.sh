...
link1_status=$(curl -Is https://download831.mediafire.com/la2pn0chnk9g/1t4n49yuxdjkqgo/Windows2012.ISO | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is https://download831.mediafire.com/la2pn0chnk9g/1t4n49yuxdjkqgo/Windows2012.ISO | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots https://download831.mediafire.com/la2pn0chnk9g/1t4n49yuxdjkqgo/Windows2012.ISO
